  ...
  return (
    <ErrorBoundary>
      <AuthProvider>
        <BrowserRouter>
          <Suspense fallback={<LoadingSpinner />}>
            ...
            <Route path="/admin" element={<AdminProtectedLayout />}>
              ...
              <Route path="employees" element={<AdminPages />} />
              ...
              <Route path="students" element={<AdminPages />} />
              <Route path="courses" element={<AdminPages />} />
              <Route path="doctors" element={<AdminPages />} />
              <Route path="appointments" element={<AdminPages />} />
              <Route path="movies" element={<AdminPages />} />
              <Route path="actors" element={<AdminPages />} />
              <Route path="teachers" element={<AdminPages />} />
              <Route path="subjects" element={<AdminPages />} />
              <Route path="stores" element={<AdminPages />} />
        ...
        <Route path="hotels" element={<AdminPages />} />
        <Route path="rooms" element={<AdminPages />} />
        <Route path="owners" element={<AdminPages />} />
        <Route path="cars" element={<AdminPages />} />
        <Route path="fabrika" element={<AdminPages />} />
        <Route path="punetori" element={<AdminPages />} />
            </Route>
